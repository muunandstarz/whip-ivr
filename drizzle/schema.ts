...
export const internalTickets = mysqlTable("internal_tickets", {
  ...
  body: text("body").notNull(),
  status: mysqlEnum("status", ["new", "triaged", "in_progress", "ready_for_approval", "approved_for_production", "resolved", "closed"]).default("new").notNull(),
  ...
  ownerNotificationError: text("owner_notification_error"),
  ...
  productionReadyByUserId: int("production_ready_by_user_id"),
  productionReadyByName: varchar("production_ready_by_name", { length: 255 }),
  productionReadyNotifiedAt: timestamp("production_ready_notified_at"),
  productionReadyNotificationError: text("production_ready_notification_error"),
  productionApprovedAt: timestamp("production_approved_at"),
  productionApprovedByUserId: int("production_approved_by_user_id"),
  productionApprovedByName: varchar("production_approved_by_name", { length: 255 }),
  productionApprovedNotifiedAt: timestamp("production_approved_notified_at"),
  productionApprovedNotificationError: text("production_approved_notification_error"),
...
export type MailSetting = typeof mailSettings.$inferSelect;
  ...
  sourceHandledAt: datetime('source_handled_at'),
  resolvedAt: datetime('resolved_at'),
  resolutionOutcome: varchar('resolution_outcome', { length: 32 }),
