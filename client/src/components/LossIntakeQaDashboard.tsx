  ...
  return <section className="rounded-2xl border border-[#151d44]/10 bg-gradient-to-b from-[#151d44]/[0.035] via-background to-background p-4 shadow-sm sm:p-6">
    <div className="flex flex-col gap-5 xl:flex-row">
      ...
      <div className="min-w-0 flex-1 space-y-5">
        {page === "brief" && <>
          <div><p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#dd571d]">Leadership / weekly report</p><h2 className="mt-1 text-2xl font-bold tracking-tight text-foreground">The week in one minute</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">Use Dispatch evidence to separate initial response, statement completion, documentation quality, and same-loss filing evidence. This scorecard is calculated from live Loss Intake records—not a manually maintained report.</p></div>
