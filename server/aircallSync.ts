...
/**
 * Start the 15-minute call synchronization job.
 * Claims QA release is deliberately manual: a leader reviews the full evidence
 * and explicitly releases an evaluation rather than automatically publishing it.
 */
